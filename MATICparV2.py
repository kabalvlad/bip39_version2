...
def Re1(hash):
    try:
        urlAdress = "https://polygonscan.com/tx/" + hash
        ...
        try:
            ...
            with open("MATICadr.txt", "a", encoding="utf-8") as f:
                f.write(V1 + '\n')
                print(V1)
        except IndexError:
...
urlHash = "https://polygonscan.com/txs"
...
while True:
    ...
    print('Scan Number MATIC [' + str(counts) + '] ')
